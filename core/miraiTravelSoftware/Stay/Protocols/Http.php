...
namespace MiraiTravel\Software\Stay\Protocols;

use MiraiTravel\Software\Stay\Connection\TcpConnection;
use MiraiTravel\Software\Stay\Protocols\Http\Request;
use MiraiTravel\Software\Stay\Protocols\Http\Response;
use MiraiTravel\Software\Stay\Protocols\Http\Session;
...
class Http
{
     ...
     * @var string
     */
    protected static $_requestClass = 'MiraiTravel\\Software\\Stay\\Protocols\\Http\\Request';
